...
public class EmployeeTest {
    ...
    public static void main(String[] args) {
        ...
        EmployeeStockPlan esp = new EmployeeStockPlan(eng);
        printEmployee(eng, esp);
        
        EmployeeStockPlan espTwo = new EmployeeStockPlan(mgr);
        printEmployee(mgr, espTwo);
        
        EmployeeStockPlan espThree = new EmployeeStockPlan(adm);
        printEmployee(adm, espThree);
        
        EmployeeStockPlan espFour = new EmployeeStockPlan(dir);
        printEmployee(dir, espFour);
