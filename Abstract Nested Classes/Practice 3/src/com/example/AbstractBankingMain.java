...
// Create several customers and their accounts
        ...
        bank.addCustomer("Bradley", "Cooper", Branch.MUMBAI);
        customer = bank.getCustomer(1);
        SavingsAccount sack = new SavingsAccount(500.00);
        customer.addAccount(sack);
        sack.deposit(500);

        bank.addCustomer("Jane", "Simms", Branch.BOSTON);
        customer = bank.getCustomer(2);
        customer.addAccount(new CheckingAccount(200.00, 400.00));

        bank.addCustomer("Kobe", "Bryant", Branch.LA);
        customer = bank.getCustomer(3);
        customer.addAccount(new CheckingAccount(2000000000000.00));

        bank.addCustomer("Tim", "Soley", Branch.BANGALORE);
